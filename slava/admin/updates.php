...
<head>
	...
	<script src="<?php echo $url;?>auth/admin/inc/updates.js"></script>
</head>
<!--- head --->
		...
		<aside class="right-side">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
						...
						<li><a href="<?=$url;?>auth/admin">Панель управления</a></li>
                        <li><a href="<?=$url;?>auth/admin/updates.php">Управление обновлениями</a></li>
                    </ol>
			</section><br>
			<!-- Main content -->
			<section class="content">
				<div class="row">
					<?php require_once "inc/updates.php"; ?>
