<tr id="forum{id}">
	<td>
		<img id="image{id}" src="../{img}" alt="Изображение форума">
	</td>
	<td>
		<div class="input-group">
			<form enctype="multipart/form-data" id="img_form{id}">
				...
				<div class="custom-file">
					<input type="file" class="custom-file-input" id="img{id}" accept="image/*" name="img">
					<label class="custom-file-label" for="img{id}">Выбрать...</label>
				</div>

				<div id="img_result{id}" class="mt-1"></div>
			</form>
			<script>
