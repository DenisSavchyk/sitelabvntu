<div class="col-lg-9 order-is-first">
	<div class="block" id="add_admin_area">
		...
		<div id="button" class="mt-2">
			<button id="store_buy_btn" class="btn btn-primary mb-0" onclick="add_admin();">Выдать</button>
			<button id="store_answer_btn" class="btn btn-outline-primary mb-0 disp-n" onclick="">Нет</button>
		</div>
	</div>
...
<div class="col-lg-3 order-is-last">
	<div class="block">
		...
		<select class="form-control mb-0" onchange="server_change();" id="store_server">
			{servers}
		</select>
	</div>
</div>
