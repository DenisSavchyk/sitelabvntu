<?php 
	...
	echo '
	<script src="'.$url.'templates/standart/plugins/jquery/2.1.4.js"></script>
	<script type="text/javascript">
		...
		function time_list()
		{
			...
			$.ajax({
				type: "POST",
				url: "'.$url.'service.php",
				data: "id=10&tarif_timee="+tarif_timee,
				success: function(data){
	...
	<div class="form-group">
		<label><i class="fa fa-diamond"></i> Выберите Привилегию:</label>
		<div id="tarif_list"></div>
        <div id="tarif_infoo"></div>
        <div id="tarif_list_timee"></div>
	</div>		
	</label>
</form>';
?>