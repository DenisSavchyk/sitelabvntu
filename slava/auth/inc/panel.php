<?php 
	...
	while( $date = $db->f_arr( $query ) ) 
	{
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Правила сервера "'.$date_server['name'].'"</h4>
	  ...
	  <div class="modal fade" id="binds">
	  <div class="modal-dialog modal-lg">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title">Бинды привилегии "'.$date_tarif['name'].'"</h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>
	...
	<div class="modal fade" id="info">
	  <div class="modal-dialog modal-lg">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title">Описание привилегии "'.$date_tarif['name'].'"</h4>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>
	...
	<div class="card-header">
	  ...
	  <div class="box-tools pull-right">
				<button class="btn btn-info btn-sm" data-toggle="modal" data-target="#info"><b>Описание вашего доната</b></button>
				<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#rules"><b>Правила</b></button>
				<button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#binds"><b>Бинды</b></button>
			</div>
	</div>
	<div class="card-body">			
				...
				<div class="input-group">
					<div class="input-group-prepend">
						...
						<input class="btn btn-success" type="submit" name="changename" value="Изменить">
				  </span></div>
				  <br><label>Ваш ник:</label>
				  <div class="input-group">
					...
					<div class="input-group-prepend">
						...
						<span class="input-group-append">
							 <input class="btn btn-success" type="submit" name="changeauth" value="Изменить">
						</span>
					</div>
				</form>
				<!-- <form action="" method="POST" autocomplete="off" style="margin: 0;"> -->
