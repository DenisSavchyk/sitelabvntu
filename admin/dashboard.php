...
<head>
	<meta charset="UTF-8">
	<title>Адміністратор - Головна</title>
				...
				<div class="row">
					<div class="col-sm-2 sidebar">
						...
						<ul id="side-menu" class="nav nav-pills navig">
							<li class="active"><a href="dashboard.php" class="nav-link links-sidebar"><i class="fas fa-columns"></i>&nbsp; Головна</a></li>
								...
								<tbody>
									...
									while ($result = mysqli_fetch_assoc($exec)){
										...
										<tr>
											...
											<td><a href="../single.php?id=<?php echo $post_id;?>"><button class="btn btn-info"><i class="fas fa-eye"></i>&nbsp;Попередній перегляд</button></a></td>
										</tr>
										<?php $postNo++; 
									} ?>
