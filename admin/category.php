				...
				<div class="row">
					...
					<div class="col-sm-2 sidebar">
						...
						<ul id="side-menu" class="nav nav-pills navig">
							...
							<li class="active"><a href="category.php" class="nav-link links-sidebar"><i class="fas fa-tags"></i>&nbsp; Категорії</a></li>
					...
					<div class="col-sm-10 content">
						...
						<h3 class="post-heading">Управління категоріями</h3>

						<form action="category.php" method="POST" enctype="multipart/form-data" name="categoryform">
							<fieldset>
								<div class="form-group">
									<label for="postTitle">Назва</label>
									<input type="text" name="categoryName" id="categoryName" class="form-control" placeholder="Додайте нову назву" ng-model="user.categoryName" required> <span style="color:red; font-weight: bold;" ng-show="categoryform.categoryName.$error.required">ВВЕСТИ ОБОВ'ЯЗКОВО</span>
								</div>

								<div class="form-group">
									<input type="submit" name="submit" class="btn btn-info" value="Додати" ng-disabled = "categoryform.$invalid">
								</div>
							</fieldset>
						</form>

						<h3 class="post-heading">Список категорій</h3>
						<table class="table">
