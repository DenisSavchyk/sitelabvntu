...
<head>
	<meta charset="UTF-8">
	<title>Логін адміністратора - JetIKy.Health</title>
...
<body style="background-color: #f1f5ff;">
	...
	<div class="container py-5 Login">
	    <div class="row">
	        <div class="col-md-12">
	            <h2 class="login-title mb-4">JetIKy.Health</h2>
	            <div class="row">
	                	...
	                	<center>
		                    <div class="card formcard rounded-0">
		                        <div class="card-header border-0 special">
		                            <h3 class="login-heading">Панель авторизації</h3>
		                        </div>
		                        <div class="card-body border-0">

		                            <form action="index.php" class="form" role="form" autocomplete="off" id="formLogin" method="POST" name="login">
		                                <div class="form-group">
		                                    <input type="text" class="form-control" name="username" id="username" placeholder="Username" autofocus="" ng-model="user.username" required> <span style="color:red; font-weight: bold;" ng-show="login.username.$error.required">ВВЕСТИ ОБОВ'ЯЗКОВО</span>
		                                </div>
		                                <div class="form-group">
		                                    <input type="password" class="form-control" name="password" id="password"  placeholder="Password" ng-model="user.password" required> <span style="color:red; font-weight: bold;" ng-show="login.password.$error.required">ВВЕСТИ ОБОВ'ЯЗКОВО</span>
		                                </div>
		                                <div class="form-group">
